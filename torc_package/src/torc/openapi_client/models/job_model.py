...
class JobModel(BaseModel):
    ...
    name: Optional[StrictStr] = Field(
        default=None, description="Name of the job; no requirements on uniqueness"
    )
    ...
    invocation_script: Optional[StrictStr] = Field(
        default=None,
        description="Wrapper script for command in case the environment needs customization.",
    )
    status: Optional[StrictStr] = Field(
        default=None, description="Status of job; managed by torc."
    )
    schedule_compute_nodes: Optional[ComputeNodeScheduleParams] = None
    cancel_on_blocking_job_failure: Optional[StrictBool] = Field(
        default=True, description="Cancel this job if any of its blocking jobs fails."
    )
    supports_termination: Optional[StrictBool] = Field(
        default=False,
        description="Informs torc that the job can be terminated gracefully before a wall-time timeout.",
    )
    blocked_by: Optional[List[StrictStr]] = Field(
        default=None, description="Database IDs of jobs that block this job"
    )
    input_files: Optional[List[StrictStr]] = Field(
        default=None, description="Database IDs of files that this job needs"
    )
    output_files: Optional[List[StrictStr]] = Field(
        default=None, description="Database IDs of files that this job produces"
    )
    input_user_data: Optional[List[StrictStr]] = Field(
        default=None, description="Database IDs of user-data objects that this job needs"
    )
    output_user_data: Optional[List[StrictStr]] = Field(
        default=None, description="Database IDs of user-data objects that this job produces"
    )
    resource_requirements: Optional[StrictStr] = Field(
        default=None, description="Optional database ID of resources required by this job"
    )
    scheduler: Optional[StrictStr] = Field(
        default=None, description="Optional database ID of scheduler needed by this job"
    )
    ...
    rev: Optional[StrictStr] = Field(
        default=None, description="Database revision of the job", alias="_rev"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "schedule_compute_nodes": ComputeNodeScheduleParams.from_dict(
                    obj["schedule_compute_nodes"]
                )
                if obj.get("schedule_compute_nodes") is not None
                else None,
                "cancel_on_blocking_job_failure": obj.get("cancel_on_blocking_job_failure")
                if obj.get("cancel_on_blocking_job_failure") is not None
                else True,
                "supports_termination": obj.get("supports_termination")
                if obj.get("supports_termination") is not None
                else False,
                ...
                "internal": JobsInternal.from_dict(obj["internal"])
                if obj.get("internal") is not None
                else None,
                "_key": obj.get("_key"),
                "_id": obj.get("_id"),
                "_rev": obj.get("_rev"),
