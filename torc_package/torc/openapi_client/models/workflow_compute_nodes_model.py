...
class WorkflowComputeNodesModel(BaseModel):
    """
    ...
    resources: ComputeNodesResources = Field(...)
    ...
    __properties = ["hostname", "pid", "start_time", "duration_seconds", "is_active", "resources", "scheduler", "_key", "_id", "_rev"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkflowComputeNodesModel:
        """Create an instance of WorkflowComputeNodesModel from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WorkflowComputeNodesModel:
        """Create an instance of WorkflowComputeNodesModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkflowComputeNodesModel.model_validate(obj)

        _obj = WorkflowComputeNodesModel.model_validate({
