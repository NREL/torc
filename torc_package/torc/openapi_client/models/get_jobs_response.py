...
class GetJobsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetJobsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetJobsResponse:
        """Create an instance of GetJobsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetJobsResponse.model_validate(obj)

        _obj = GetJobsResponse.model_validate({
