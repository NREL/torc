...
class GetJobsKeyUserDataConsumesResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetJobsKeyUserDataConsumesResponse:
        """Create an instance of GetJobsKeyUserDataConsumesResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetJobsKeyUserDataConsumesResponse:
        """Create an instance of GetJobsKeyUserDataConsumesResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetJobsKeyUserDataConsumesResponse.model_validate(obj)

        _obj = GetJobsKeyUserDataConsumesResponse.model_validate({
