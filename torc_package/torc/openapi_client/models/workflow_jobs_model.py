...
class WorkflowJobsModel(BaseModel):
    """
    WorkflowJobsModel
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkflowJobsModel:
        """Create an instance of WorkflowJobsModel from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WorkflowJobsModel:
        """Create an instance of WorkflowJobsModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkflowJobsModel.model_validate(obj)

        _obj = WorkflowJobsModel.model_validate({
            "name": obj.get("name"),
