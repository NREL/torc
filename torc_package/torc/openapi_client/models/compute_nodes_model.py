...
class ComputeNodesModel(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ComputeNodesModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ComputeNodesModel:
        """Create an instance of ComputeNodesModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ComputeNodesModel.model_validate(obj)

        _obj = ComputeNodesModel.model_validate({
