...
class GetResultsResponse(BaseModel):
    ...
    GetResultsResponse
    """
    items: Optional[Annotated[List[ResultsModel], Field()]] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetResultsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetResultsResponse:
        """Create an instance of GetResultsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetResultsResponse.model_validate(obj)

        _obj = GetResultsResponse.model_validate({
            "items": [ResultsModel.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "skip": obj.get("skip"),
