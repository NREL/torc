...
class GetWorkflowsWorkflowJobsResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetWorkflowsWorkflowJobsResponse:
        """Create an instance of GetWorkflowsWorkflowJobsResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetWorkflowsWorkflowJobsResponse:
        """Create an instance of GetWorkflowsWorkflowJobsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetWorkflowsWorkflowJobsResponse.model_validate(obj)

        _obj = GetWorkflowsWorkflowJobsResponse.model_validate({
