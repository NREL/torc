...
class ResourceRequirementsModel(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceRequirementsModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResourceRequirementsModel:
        """Create an instance of ResourceRequirementsModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceRequirementsModel.model_validate(obj)

        _obj = ResourceRequirementsModel.model_validate({
            "name": obj.get("name"),
