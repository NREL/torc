...
class GetComputeNodesResponse(BaseModel):
    """
    GetComputeNodesResponse
    """
    items: Optional[Annotated[List[ComputeNodesModel], Field()]] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetComputeNodesResponse:
        """Create an instance of GetComputeNodesResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetComputeNodesResponse:
        """Create an instance of GetComputeNodesResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetComputeNodesResponse.model_validate(obj)

        _obj = GetComputeNodesResponse.model_validate({
