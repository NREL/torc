...
class GetFilesProducedByJobKeyResponse(BaseModel):
    """
    GetFilesProducedByJobKeyResponse
    """
    items: Optional[Annotated[List[FilesModel], Field()]] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetFilesProducedByJobKeyResponse:
        """Create an instance of GetFilesProducedByJobKeyResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetFilesProducedByJobKeyResponse:
        """Create an instance of GetFilesProducedByJobKeyResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetFilesProducedByJobKeyResponse.model_validate(obj)

        _obj = GetFilesProducedByJobKeyResponse.model_validate({
