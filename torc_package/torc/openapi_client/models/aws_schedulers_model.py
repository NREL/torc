...
class AwsSchedulersModel(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AwsSchedulersModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AwsSchedulersModel:
        """Create an instance of AwsSchedulersModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AwsSchedulersModel.model_validate(obj)

        _obj = AwsSchedulersModel.model_validate({
            "name": obj.get("name"),
            "key": obj.get("_key"),
            "id": obj.get("_id"),
            "rev": obj.get("_rev")
