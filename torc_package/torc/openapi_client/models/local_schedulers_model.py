...
class LocalSchedulersModel(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LocalSchedulersModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LocalSchedulersModel:
        """Create an instance of LocalSchedulersModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LocalSchedulersModel.model_validate(obj)

        _obj = LocalSchedulersModel.model_validate({
