...
class DefaultApi(object):
    ...
    @validate_call
    def post_workflows_key_initialize_jobs(self, key : Annotated[StrictStr, Field(..., description="Workflow key")], only_uninitialized : Annotated[Optional[StrictBool], Field(description="Only initialize jobs with a status of uninitialized.")] = None, clear_ephemeral_user_data : Annotated[Optional[StrictBool], Field(description="Clear all ephemeral user data.")] = None, body : Optional[Dict[str, Any]] = None, **kwargs) -> object:  # noqa: E501
        ...
        return self.post_workflows_key_initialize_jobs_with_http_info(key, only_uninitialized, clear_ephemeral_user_data, body, **kwargs)  # noqa: E501

    @validate_call
    def post_workflows_key_initialize_jobs_with_http_info(self, key : Annotated[StrictStr, Field(..., description="Workflow key")], only_uninitialized : Annotated[Optional[StrictBool], Field(description="Only initialize jobs with a status of uninitialized.")] = None, clear_ephemeral_user_data : Annotated[Optional[StrictBool], Field(description="Clear all ephemeral user data.")] = None, body : Optional[Dict[str, Any]] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Initialize job relationships.  # noqa: E501
