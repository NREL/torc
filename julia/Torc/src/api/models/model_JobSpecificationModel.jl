...
Base.@kwdef mutable struct JobSpecificationModel <: OpenAPI.APIModel
    ...
    function JobSpecificationModel(name, key, command, invocation_script, cancel_on_blocking_job_failure, supports_termination, scheduler, needs_compute_node_schedule, input_user_data, output_user_data, resource_requirements, input_files, output_files, blocked_by, )
        ...
        OpenAPI.validate_property(JobSpecificationModel, Symbol("invocation_script"), invocation_script)
        ...
        OpenAPI.validate_property(JobSpecificationModel, Symbol("resource_requirements"), resource_requirements)
...
const _property_types_JobSpecificationModel = Dict{Symbol,String}(Symbol("name")=>"String", Symbol("key")=>"String", Symbol("command")=>"String", Symbol("invocation_script")=>"String", Symbol("cancel_on_blocking_job_failure")=>"Bool", Symbol("supports_termination")=>"Bool", Symbol("scheduler")=>"String", Symbol("needs_compute_node_schedule")=>"Bool", Symbol("input_user_data")=>"Vector{String}", Symbol("output_user_data")=>"Vector{String}", Symbol("resource_requirements")=>"String", Symbol("input_files")=>"Vector{String}", Symbol("output_files")=>"Vector{String}", Symbol("blocked_by")=>"Vector{String}", )
