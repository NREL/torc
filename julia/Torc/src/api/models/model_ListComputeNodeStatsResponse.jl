...
Base.@kwdef mutable struct ListComputeNodeStatsResponse <: OpenAPI.APIModel
    ...
    function ListComputeNodeStatsResponse(items, skip, max_limit, count, total_count, has_more, )
        OpenAPI.validate_property(ListComputeNodeStatsResponse, Symbol("items"), items)
        OpenAPI.validate_property(ListComputeNodeStatsResponse, Symbol("skip"), skip)
        OpenAPI.validate_property(ListComputeNodeStatsResponse, Symbol("max_limit"), max_limit)
        OpenAPI.validate_property(ListComputeNodeStatsResponse, Symbol("count"), count)
        OpenAPI.validate_property(ListComputeNodeStatsResponse, Symbol("total_count"), total_count)
        OpenAPI.validate_property(ListComputeNodeStatsResponse, Symbol("has_more"), has_more)
...
function check_required(o::ListComputeNodeStatsResponse)
