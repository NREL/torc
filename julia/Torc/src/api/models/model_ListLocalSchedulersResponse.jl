...
@doc raw"""list_local_schedulers_response
...
Base.@kwdef mutable struct ListLocalSchedulersResponse <: OpenAPI.APIModel
    ...
    function ListLocalSchedulersResponse(items, skip, max_limit, count, total_count, has_more, )
        OpenAPI.validate_property(ListLocalSchedulersResponse, Symbol("items"), items)
        OpenAPI.validate_property(ListLocalSchedulersResponse, Symbol("skip"), skip)
        OpenAPI.validate_property(ListLocalSchedulersResponse, Symbol("max_limit"), max_limit)
        OpenAPI.validate_property(ListLocalSchedulersResponse, Symbol("count"), count)
        OpenAPI.validate_property(ListLocalSchedulersResponse, Symbol("total_count"), total_count)
        OpenAPI.validate_property(ListLocalSchedulersResponse, Symbol("has_more"), has_more)
