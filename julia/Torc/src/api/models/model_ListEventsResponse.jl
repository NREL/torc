...
Base.@kwdef mutable struct ListEventsResponse <: OpenAPI.APIModel
    ...
    function ListEventsResponse(items, skip, max_limit, count, total_count, has_more, )
        OpenAPI.validate_property(ListEventsResponse, Symbol("items"), items)
        OpenAPI.validate_property(ListEventsResponse, Symbol("skip"), skip)
        OpenAPI.validate_property(ListEventsResponse, Symbol("max_limit"), max_limit)
        OpenAPI.validate_property(ListEventsResponse, Symbol("count"), count)
        OpenAPI.validate_property(ListEventsResponse, Symbol("total_count"), total_count)
        OpenAPI.validate_property(ListEventsResponse, Symbol("has_more"), has_more)
...
function check_required(o::ListEventsResponse)
