...
**blocked_by_job_id** | **Int64** | The job that must complete first | [default to nothing]
**blocked_by_job_name** | **String** | The name of the job that must complete first | [default to nothing]
