...
.. code-block:: console
    ...
    $ pip install git+ssh://git@github.nrel.gov/viz/torc.git@v0.3.4#subdirectory=torc_package
...
.. code-block:: console
    ...
    $ using Pkg
    $ Pkg.add(PackageSpec(url="git@github.nrel.gov:viz/torc.git", rev="v0.3.4", subdir="julia/Torc"))
