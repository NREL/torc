...
.. code-block:: console
    ...
    $ pip install git+ssh://git@github.nrel.gov/viz/wms.git@v0.2.3#subdirectory=torc_package \
...
.. code-block:: console
    ...
    $ using Pkg
    $ Pkg.add(PackageSpec(url="git@github.nrel.gov:viz/wms.git", rev="v0.2.3", subdir="julia/Torc"))
