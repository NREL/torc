...
- [Slurm Workflows](./explanation/slurm-workflows.md) — How Torc manages Slurm
- [Resource Requirements](./reference/resources.md) — All resource options
- [HPC Profiles](./how-to/hpc-profiles.md) — Managing HPC configurations
- [Working with Slurm](./how-to/slurm.md) — Advanced Slurm configuration
- [Debugging Slurm Workflows](./how-to/debugging-slurm.md) — Troubleshooting
