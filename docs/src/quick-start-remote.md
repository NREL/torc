...
For local execution, see [Quick Start (Local)](./quick-start-local.md). For HPC/Slurm execution, see
...
- [Remote Workers Guide](./how-to/remote-workers.md) - Detailed configuration and troubleshooting
- [Creating Workflows](./how-to/creating-workflows.md) - Workflow specification format
- [Resource Monitoring](./how-to/resource-monitoring.md) - Track CPU/memory usage per job
